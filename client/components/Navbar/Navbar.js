...
const Navbar = () => {
    ...
    const { user, profilePic, logout } = useAuth(); // Use the useAuth hook
                        ...
                        {user ? (
                            <div className="flex items-center space-x-4">
                                ...
                                <div className="relative w-10 h-10 rounded-full overflow-hidden cursor-pointer">
                                    <Image
                                        src={`http://localhost:4000/${profilePic || 'logo.png'}`}
                                        alt="Profile"
                                        layout="fill"
                                        objectFit="cover"
                                        className="rounded-full"
                                    />
                                    {/* Profile Picture Upload (to be implemented) */}
                                ...
                                {/* User Name */}
                                <Link href={`/profile/${user.id}`} passHref>
                                    <span className="text-zinc-700 text-[1.03rem] font-semibold cursor-pointer">
                                ...
                                {/* Logout Button */}
                                <button 
                                    className="font-semibold bg-gradient-to-tr from-red-200 to-pink-200 py-2 px-3 rounded-xl text-gray-800 hover:from-red-300 hover:to-pink-200"
                    ...
                    <div className="flex justify-between sm:px-5 px-3 py-2">
                        ...
                        <div className="flex items-center">
                            ...
                            <div className="flex items-center">
                                ...
                                >
                                    <span
                                        className="logo-text text-transparent text-1xl font-bold group-hover:text-blue-500"
                                        style={{
                                            WebkitTextStroke: ".7px #000",
                                            transition: "color 0.5s ease",
                                        }}
